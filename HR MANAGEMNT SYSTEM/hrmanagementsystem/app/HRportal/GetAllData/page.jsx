...
export default function DisplayDetails() {
    ...
    useEffect(() => {
      ...
      if (!token) {
          ...
          fetch('/api/verifyOtp', {
              ...
              .then((res) => {
                  if (res.status !== 200) {
                      router.push('/HRportal/GetAllData');
                  }
              })
              .catch(() => router.push('/'));
      }
    ...
    ///Download file content function/////////////
    const exportToExcel = () => {
    ...
    return (
        ...
        <div className="p-6"  >
            <h1 className="text-3xl text-center font-bold mb-4">Employee Details</h1>
            ...
            <table className="min-w-full border border-gray-300 rounded-lg text-sm overflow-hidden">
                <thead className="bg-gray-200 " id="contentToDownload">
                    <tr>
