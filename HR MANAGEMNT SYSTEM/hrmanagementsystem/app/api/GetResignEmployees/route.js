...
export async function GET() {
    ...
    try {
        ...
        const [personalData] = await connection.query(`
            ...
            where em.currentStatus ='Resigned' OR em.currentStatus='Terminate'`); // Enclose 'Resigned/Terminate' in quotes
        ...
        WHERE em.currentStatus ='Resigned' OR em.currentStatus='Terminate'`);
        ...
        WHERE em.currentStatus ='Resigned' OR em.currentStatus='Terminate'`);
        const [employmentData] = await connection.query(`SELECT * FROM employment_detail em WHERE em.currentStatus ='Resigned' OR em.currentStatus='Terminate'`);
