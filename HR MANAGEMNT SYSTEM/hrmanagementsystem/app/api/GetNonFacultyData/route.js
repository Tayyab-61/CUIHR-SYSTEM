...
export async function GET() {
    ...
    try {
        ...
        const [personalData] = await connection.query(`
            ...
            WHERE em.grade = 'NonFaculty'`); // Enclose 'faculty' in quotes
        ...
        WHERE em.grade = 'NonFaculty'`);
        const [employmentData] = await connection.query(`SELECT * FROM employment_detail em where em.grade = 'NonFaculty'`);
