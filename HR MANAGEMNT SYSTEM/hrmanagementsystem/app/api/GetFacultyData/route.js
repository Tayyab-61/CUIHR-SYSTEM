...
export async function GET() {
    ...
    try {
        ...
        const [personalData] = await connection.query(`
            ...
            WHERE em.grade= 'Faculty'`); // Enclose 'Faculty' in quotes
        ...
        WHERE em.grade = 'Faculty'`);
        const [employmentData] = await connection.query(`SELECT * FROM employment_detail em where em.grade = 'Faculty'`);
